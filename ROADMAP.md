...
- The staging API runs reviewed digest `sha256:4974160e513e9406e18a9836dff32daf15866b7d63ab7534d415b4bc942130b9` on healthy revision `family-dashboard-staging-api--0000031` with 100% traffic. Netlify production deploy `6a8dd663285b7d00087e4d79` serves the reward UI commit; the later catalog correction is backend-only.
...
- Deploy and staging-verify controlled Calendar editing/deletion for simple, non-recurring events created through Family Dashboard; externally sourced and recurring events remain read-only.
