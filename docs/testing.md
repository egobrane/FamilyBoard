...
Vitest and React Testing Library cover authentication states, first-household setup, multi-household selection, invitation creation and fragment removal, shared-display PIN entry, credentialed/antiforgery API behavior, dashboard semantics, mock feature content, and keyboard and pointer navigation.
